...
class Browser:
    ...
    def _wait_until_click(
        self, by: str, value: str, timeout: float = 20.0
    ) -> Union[Any, None]:
    ...
    def _wait_until_found(
        ...
        return WebDriverWait(
            self.driver, timeout=timeout, ignored_exceptions=IGNORE_EXCEPTIONS
        ).until(self.driver.find_element(by=by, value=value))
    ...
    def add_text_input(
        self, by: str, value: str, text: str, wait: bool = True
    ) -> None:
