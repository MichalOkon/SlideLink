...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train Mask R-CNN to detect slides.")
    parser.add_argument("command", metavar="<command>", help="'train' or 'splash'")
    parser.add_argument(
        "--dataset", required=False, metavar="/path/to/slide/dataset/", help="Directory of the Slide dataset"
    )
    parser.add_argument(
