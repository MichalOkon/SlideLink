...
def fpn_classifier_graph(
    ...
    s = K.int_shape(x)
    reshape_x_val = -1 if s[1] is None else s[1]
    mrcnn_bbox = KL.Reshape((reshape_x_val, num_classes, 4), name="mrcnn_bbox")(x)
...
class MaskRCNN:
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.log_dir = os.path.join(curr_dir, "logdir", "train")
    ...
    def train(
        ...
        augmentation: Optional. An imgaug (https://github.com/aleju/imgaug)
            ...
            custom_callbacks: Optional. Add custom callbacks to be called
                with the keras fit_generator method. Must be list of type tf.keras.callbacks.
        no_augmentation_sources: Optional. List of sources to exclude for
            augmentation. A source is string that identifies a dataset and is
            defined in the Dataset class.
        """
